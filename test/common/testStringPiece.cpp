 ...
 *  https://github.com/protocolbuffers/protobuf/blob/master/src/google/protobuf/stubs/stringpiece_unittest.cc
 */
...
TEST(TestCommonStringPiece, TestStringCompareNotAmbiguous) {
  EXPECT_EQ("hello", std::string("hello"));
  EXPECT_LT("hello", std::string("world"));
}

// TEST(TestCommonStringPiece, TestHeterogenousStringPieceEquals) {
