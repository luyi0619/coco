...
TEST(TestCalvinPartitioner, TestBasic) {
...

  {
    ...
    CalvinPartitioner p0 = CalvinPartitioner(0, 9, replica_group_sizes);
    EXPECT_EQ(p0.replica_group_id, 0);
    EXPECT_EQ(p0.replica_group_size, 2);

    CalvinPartitioner p1 = CalvinPartitioner(1, 9, replica_group_sizes);
    EXPECT_EQ(p1.replica_group_id, 0);
    EXPECT_EQ(p1.replica_group_size, 2);

    CalvinPartitioner p2 = CalvinPartitioner(2, 9, replica_group_sizes);
    EXPECT_EQ(p2.replica_group_id, 1);
    EXPECT_EQ(p2.replica_group_size, 3);

    CalvinPartitioner p3 = CalvinPartitioner(3, 9, replica_group_sizes);
    EXPECT_EQ(p3.replica_group_id, 1);
    EXPECT_EQ(p3.replica_group_size, 3);

    CalvinPartitioner p4 = CalvinPartitioner(4, 9, replica_group_sizes);
    EXPECT_EQ(p4.replica_group_id, 1);
    EXPECT_EQ(p4.replica_group_size, 3);

    CalvinPartitioner p5 = CalvinPartitioner(5, 9, replica_group_sizes);
    EXPECT_EQ(p5.replica_group_id, 2);
    EXPECT_EQ(p5.replica_group_size, 4);

    CalvinPartitioner p6 = CalvinPartitioner(6, 9, replica_group_sizes);
    EXPECT_EQ(p6.replica_group_id, 2);
    EXPECT_EQ(p6.replica_group_size, 4);

    CalvinPartitioner p7 = CalvinPartitioner(7, 9, replica_group_sizes);
    EXPECT_EQ(p7.replica_group_id, 2);
    EXPECT_EQ(p7.replica_group_size, 4);

    CalvinPartitioner p8 = CalvinPartitioner(8, 9, replica_group_sizes);
...

  {
    ...
    CalvinPartitioner p0 = CalvinPartitioner(0, 4, replica_group_sizes);
    EXPECT_EQ(p0.replica_group_id, 0);
    EXPECT_EQ(p0.replica_group_size, 1);

    CalvinPartitioner p1 = CalvinPartitioner(1, 4, replica_group_sizes);
    EXPECT_EQ(p1.replica_group_id, 1);
    EXPECT_EQ(p1.replica_group_size, 3);

    CalvinPartitioner p2 = CalvinPartitioner(2, 4, replica_group_sizes);
    EXPECT_EQ(p2.replica_group_id, 1);
    EXPECT_EQ(p2.replica_group_size, 3);

    CalvinPartitioner p3 = CalvinPartitioner(3, 4, replica_group_sizes);
    EXPECT_EQ(p3.replica_group_id, 1);
    EXPECT_EQ(p3.replica_group_size, 3);
  }
}
