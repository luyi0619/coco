...
#define STRUCT_PARAM_REST_X(type, name) \
    , type name

#define STRUCT_INITLIST_FIRST_X(type, name) \
    name(name)

#define STRUCT_INITLIST_REST_X(type, name) \
    , name(name)

#define STRUCT_HASH_FIRST_X(type, name) \
    k.name

#define STRUCT_HASH_REST_X(type, name) \
    , k.name

#define STRUCT_LAYOUT_X(type, name) \
    type name;
...
#define STRUCT_FIELDPOS_X(type, name) \
    name ## _field,
