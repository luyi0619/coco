...
class ScarSIExecutor
    : public group_commit::Executor<Workload,
                                    ScarSI<typename Workload::DatabaseType>>

{
public:
  using base_type =
      group_commit::Executor<Workload, ScarSI<typename Workload::DatabaseType>>;

  using WorkloadType = Workload;
  using ProtocolType = ScarSI<typename Workload::DatabaseType>;
  ...
  ScarSIExecutor(std::size_t coordinator_id, std::size_t id, DatabaseType &db,
