...
namespace scar {
    ...
    public:
        ...
        bool is_lock_bit() const {
            return bitvec & __lock_bit_mask;
        }

        // table_id
        std::size_t get_table_id() const {
            return (bitvec & __table_id_mask) >> 16;
        }
        ...
        void set_sort_key(void *sort_key) {
            this->sort_key = sort_key;
        }

        void *get_sort_key() const {
            return sort_key;
        }
    ...
    private:
        ...
        /*
         *   A bitvec is a 64-bit word. 16 bits for status bits. 16 bits for table id. 32 bits for partition id.
