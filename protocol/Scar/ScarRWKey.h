...
public:
  ...
  void set_wts_change_in_read_validation_bit() {
    ...
    bitvec |= WTS_CHANGE_IN_READ_VALIDATION_BIT_MASK
              << WTS_CHANGE_IN_READ_VALIDATION_BIT_OFFSET;
  }
  ...
  bool get_wts_change_in_read_validation_bit() const {
    return (bitvec >> WTS_CHANGE_IN_READ_VALIDATION_BIT_OFFSET) &
           WTS_CHANGE_IN_READ_VALIDATION_BIT_MASK;
  }
