...
// table definition for scaled_tpcc
namespace scar {
...
#define NAMESPACE_FIELDS(x) x(scar) x(scaled_tpcc)
...
template <> class Serializer<scaled_tpcc::warehouse::value> {
public:
  std::string operator()(const scaled_tpcc::warehouse::value &v) {
    return Serializer<decltype(v.W_YTD)>()(v.W_YTD);
  }
};

template <> class Deserializer<scaled_tpcc::warehouse::value> {
public:
  std::size_t operator()(StringPiece str,
                         scaled_tpcc::warehouse::value &result) const {
    return Deserializer<decltype(result.W_YTD)>()(str, result.W_YTD);
  }
};

template <> class ClassOf<scaled_tpcc::warehouse::value> {
public:
  static constexpr std::size_t size() {
    return ClassOf<decltype(scaled_tpcc::warehouse::value::W_YTD)>::size();
  }
};

template <> class Serializer<scaled_tpcc::district::value> {
public:
  std::string operator()(const scaled_tpcc::district::value &v) {
    return Serializer<decltype(v.D_YTD)>()(v.D_YTD) +
           Serializer<decltype(v.D_NEXT_O_ID)>()(v.D_NEXT_O_ID);
  }
};

template <> class Deserializer<scaled_tpcc::district::value> {
public:
  std::size_t operator()(StringPiece str,
                         scaled_tpcc::district::value &result) const {
    std::size_t sz_ytd =
...
template <> class ClassOf<scaled_tpcc::district::value> {
public:
  static constexpr std::size_t size() {
    return ClassOf<decltype(scaled_tpcc::district::value::D_YTD)>::size() +
           ClassOf<decltype(scaled_tpcc::district::value::D_NEXT_O_ID)>::size();
  }
};

template <> class Serializer<scaled_tpcc::customer::value> {
public:
  std::string operator()(const scaled_tpcc::customer::value &v) {
...
template <> class Deserializer<scaled_tpcc::customer::value> {
public:
  std::size_t operator()(StringPiece str,
                         scaled_tpcc::customer::value &result) const {
    std::size_t sz_data =
...
template <> class ClassOf<scaled_tpcc::customer::value> {
public:
  static constexpr std::size_t size() {
    return ClassOf<decltype(scaled_tpcc::customer::value::C_DATA)>::size() +
           ClassOf<decltype(scaled_tpcc::customer::value::C_BALANCE)>::size() +
           ClassOf<decltype(
               scaled_tpcc::customer::value::C_YTD_PAYMENT)>::size() +
           ClassOf<decltype(
               scaled_tpcc::customer::value::C_PAYMENT_CNT)>::size();
  }
};

template <> class Serializer<scaled_tpcc::stock::value> {
public:
  std::string operator()(const scaled_tpcc::stock::value &v) {
...
template <> class Deserializer<scaled_tpcc::stock::value> {
public:
  std::size_t operator()(StringPiece str,
                         scaled_tpcc::stock::value &result) const {
...
template <> class ClassOf<scaled_tpcc::stock::value> {
public:
  static constexpr std::size_t size() {
    return ClassOf<decltype(scaled_tpcc::stock::value::S_QUANTITY)>::size() +
           ClassOf<decltype(scaled_tpcc::stock::value::S_YTD)>::size() +
           ClassOf<decltype(scaled_tpcc::stock::value::S_ORDER_CNT)>::size() +
           ClassOf<decltype(scaled_tpcc::stock::value::S_REMOTE_CNT)>::size();
  }
};
