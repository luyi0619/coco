...
#ifndef SCAR_TPCCRANDOM_H
#define SCAR_TPCCRANDOM_H
...
namespace scar {
    ...
    class TPCCRandom : public Random {
    public:
        using Random::Random;
    ...
    private:
        ...
        static const std::vector<std::string> &customer_last_names() {
            static std::vector<std::string> last_names = {"BAR", "OUGHT", "ABLE", "PRI", "PRES", "ESE",
                                                          "ANTI", "CALLY", "ATION",
                                                          "EING"};
            return last_names;
        }
